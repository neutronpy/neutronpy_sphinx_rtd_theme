  ...
  grunt.initConfig({
        ...
        files: [
          {
              ...
              dest: 'neutronpy_sphinx_rtd_theme/static/fonts/',
              filter: 'isFile'
          },
          {
              expand: true,
    ...
    sass: {
      dev: {
        ...
        files: [{
          ...
          cwd: 'sass',
          src: ['*.sass'],
          dest: 'neutronpy_sphinx_rtd_theme/static/css',
          ext: '.css'
        }]
      },
      build: {
    ...
    browserify: {
      dev: {
        ...
        src: ['js/*.js'],
        dest: 'neutronpy_sphinx_rtd_theme/static/js/theme.js'
      },
      build: {
        options: {
          external: ['jquery'],
    ...
    clean: {
      build: ["docs/build"],
      fonts: ["neutronpy_sphinx_rtd_theme/static/fonts"],
      css: ["neutronpy_sphinx_rtd_theme/static/css"],
      js: ["neutronpy_sphinx_rtd_theme/static/js/*", "!neutronpy_sphinx_rtd_theme/static/js/modernizr.min.js"]
    },
    ...
    watch: {
      ...
      sphinx: {
        files: ['neutronpy_sphinx_rtd_theme/**/*', 'README.rst', 'docs/**/*.rst', 'docs/**/*.py'],
